export function StreamingIndicator() {
  return (
    <div className="flex items-center gap-2 px-4 py-2" role="status" aria-label="AI is generating a response">
      ...
      <span className="text-xs text-gray-500 dark:text-gray-400">Keystone is thinking...</span>
    </div>
  )
}
